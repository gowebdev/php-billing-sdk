...
class AuthentifyUserTest extends \PHPUnit_Framework_TestCase
{
    protected $_factory;
    ...
    public function testSend()
    {
        ...
        $client = $this->_factory->authentifyUser('identity@server.com', '==password==', 12345);
    ...
    public function testSendWrongCredentials()
    {
        ...
        $this->_factory->authentifyUser('identity@server.com', '==password==', 12345);
    }
